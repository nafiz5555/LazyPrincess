...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ⚡", url='https://t.me/cinebazaar/21'),
        ] 
    )
    if 0 < offset <= 10:
        off_set = 0
...
async def filter_seasons_cb_handler(client: Client, query: CallbackQuery):
    try:
        ...
        btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ⚡", url='https://telegram.me/cinebazaar/21'),
        ] 
    )
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @CineDramaBot ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You CineDrama ♥️')
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Requested file has been sent to you privately. Check PM sweetheart ❤', show_alert=False)
                l = await client.send_message(chat_id = query.from_user.id, text=f"<b>⚠ <u>warning ⚠</u> </b>\n\n<b>ᴛʜɪꜱ ᴠɪᴅᴇᴏ / ꜰɪʟᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ</b> <b><u>1 ᴍɪɴᴜᴛᴇꜱ</u> </b><b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ).</b>\n\n<b><i>📌 ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ᴠɪᴅᴇᴏ / ꜰɪʟᴇ ᴛᴏ ꜱᴏᴍᴇᴡʜᴇʀᴇ ᴇʟꜱᴇ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴛʜᴇʀᴇ.</i></b>")
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("Don't Be Oversmart sona 😒", show_alert=True)
            return
        ident, file_id = query.data.split("#")
        files_ = await get_file_details(file_id)
        if not files_:
        ...
        await query.answer('♥️ Thank You CineDrama ♥️')
        ...
        buttons = InlineKeyboardMarkup(
            ...
            InlineKeyboardButton('💤Developer', url='https://telegram.me/Netflix_Dramas')
            ],[
            InlineKeyboardButton('🔐 Close', callback_data='close_data')
            ]]
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 ══• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •══ 🐞", url=f"https://telegram.me/SoulOfDrama")
            ]]
            btn_lzdv = [
                [
    ...
    if imdb and imdb.get('poster'):
        try:
            z = await message.reply_photo(photo=imdb.get('poster'), caption=cap[:1024],
                                        reply_markup=InlineKeyboardMarkup(btn))
            thanksaa = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/CineBazaar'>𓆩• CineDrama •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            ...
            thanks = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/CineBazaar'>𓆩• CineDrama •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            await asyncio.sleep(5)
            await thanks.delete()
            if SELF_DELETE:
                await asyncio.sleep(SELF_DELETE_SECONDS)
            ...
            thanksz = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/CineBazaar'>𓆩• CineDrama •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            await asyncio.sleep(5)
        ...
        thanksx = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/CineBazaar'>𓆩• CineDrama •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
        await asyncio.sleep(5)
